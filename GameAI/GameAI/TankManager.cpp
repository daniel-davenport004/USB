...
#include "DumbTank.h"
#include "d016619f\d016619fTank.h"
#include <cassert>
...
BaseTank* TankManager::GetTankObject(SDL_Renderer* renderer, TankSetupDetails details)
{
	...
	if (details.StudentName == "d016619fTank")
	{
		d016619fTank* newd016619fTank = new d016619fTank(renderer, details);
		newBaseTank = (BaseTank*)newd016619fTank;
	}
	else if(details.StudentName == "ControlledTank")
	{
