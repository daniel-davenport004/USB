...
HRESULT Application::Initialise(HINSTANCE hInstance, int nCmdShow)
{
	...
	Transform * transformObject = new Transform();
	transformObject->SetPosition(0.0f, 0.0f, 0.0f);
	transformObject->SetScale(15.0f, 15.0f, 15.0f);
	transformObject->SetRotation(XMConvertToRadians(90.0f), 0.0f, 0.0f);
	...
	for (auto i = 0; i < 5; i++)
	{
		...
		transformObject->SetScale(0.5f, 0.5f, 0.5f);
		transformObject->SetPosition(-4.0f + (i * 2.0f), 0.5f, 10.0f);
...
void Application::Update(DWORD elapsedTime)
{
	// Move gameobject
